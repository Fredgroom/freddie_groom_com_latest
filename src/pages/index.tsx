...
const Home = () => {
  return (
    <div className='flex flex-col items-center'>
      <h1 className='text-8xl break-words mb-8 text-center'>Hi, I'm Freddie</h1>
      <h2 className='text-4xl break-words m-0 mb-4 text-center'>
        I turn designs into products
      </h2>
      <Skills />
      <div className='flex flex-col items-center sm:flex-row flex-wrap justify-center py-8 gap-8'>
