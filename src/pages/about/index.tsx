  ...
  return (
    <>
      ...
      <p>
        ...
        experience in building responsive, data-driven web applications using
        React and TypeScript. I build responsive data-driven web interfaces with
        reusable components and am comfortable refactoring existing projects or
        building from the ground up. I meet project deadlines when requirements
        need to be extended, both independently and within multidisciplinary
        teams.
      </p>
      <p>
        ...
        colleagues and interacting with clients. In my free time, I explore new
        technologies and build projects for charity.
      </p>
      <p>
